function write_joyrad94_data_2_nc(data,outfile)
...
netcdf.putAtt(ncid,id_QF,'long_name','Quality flag: bit4 = ADC saturation, bit3 = spectral width too high, bit2 = no transmitter power leveling.');
netcdf.putAtt(ncid,id_QF,'comment',['To get the bit entries, one has to convert the integer into a 4 bit binary. '...
    'Note that in the above convention holds: bit1 = 2^3, bit2 = 2^2, bit3 = 2, bit4 = 2^0'])
